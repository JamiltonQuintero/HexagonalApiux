package com.jamiltonquintero.hexagonalmodularmaven.user.adapter.repository;

import com.jamiltonquintero.hexagonalmodularmaven.user.adapter.UserSpringJpaAdapterRepository;
